// listen for the document to be finished loading. this code is boilerplate, will always have it
document.addEventListener('DOMContentLoaded', async function(event) {
  ...
  submitButton.addEventListener(`click`, async function(event) {
    ...
    // - Fetch the url, wait for a response, store the response in memory. THIS IS THE RECIPE FOR FETCH
    let response = await fetch(url) //we do await because we want it to wait until it returns, could be a long time
